...
This catches corrupted WASM files, missing imports, and runtime initialization
failures.

## Floating-Point Tolerance

WASM and JavaScript both follow IEEE 754, but implementation details can cause
tiny differences. Use `assertAlmostEquals`:
...
4. **Add logging** — Temporarily add `console.log` in your runtime's `write`
   function
