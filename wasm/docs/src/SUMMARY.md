...
- [Getting Started](./part1/ch01-getting-started.md)
- [Building the Runtime Bridge](./part1/ch02-runtime-bridge.md)
- [Testing WASM Integration](./part1/ch03-testing.md)
...
- [Advanced Memory Management](./part3/ch08-advanced-memory.md)
- [Multiple Instances](./part3/ch09-multiple-instances.md)
- [Real-World Applications](./part3/ch10-applications.md)

# Part IV: Building & Shipping

- [Build Automation](./part4/ch10-build-automation.md)
- [Performance Optimization](./part4/ch11-performance.md)
- [Production Deployment](./part4/ch12-production.md)
