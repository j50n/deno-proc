...
library, designed to measure and compare the efficiency of different data format
transformers.
...
- **Selective access**: Access only specific fields (LazyRow optimization
  target)
...
- **Primary benchmark** using real file streaming with
  `enumerate(file.readable)`
