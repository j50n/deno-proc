...
(function codeSnippets() {
  ...
  Array.from(document.querySelectorAll("code.language-rust")).forEach(
    function (block) {
      ...
      pre_block.querySelector(".buttons").addEventListener(
        "click",
        function (e) {
...
(function themes() {
  ...
  function updateThemeSelected() {
    ...
    themePopup.querySelector("button#" + get_theme()).classList.add(
      "theme-selected",
    );
  }
  ...
  themePopup.addEventListener("focusout", function (e) {
    ...
    if (
      !!e.relatedTarget && !themeToggleButton.contains(e.relatedTarget) &&
  ...
  document.addEventListener("click", function (e) {
    if (
      themePopup.style.display === "block" &&
      !themeToggleButton.contains(e.target) && !themePopup.contains(e.target)
    ) {
      hideThemes();
    }
  });
...
(function sidebar() {
  ...
  var activeSection = document.getElementById("sidebar").querySelector(
    ".active",
  );
  if (activeSection) {
