  ...
  var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    i = function () {
      ...
      return n(e, [{
        ...
        value: function () {
          var e = [];
          return (void 0 !== this.ctx && this.ctx
        ...
        value: function (e, t) {
          var n = "string" == typeof t ? [t] : t,
            r = e.matches || e.matchesSelector || e.msMatchesSelector ||
              e.mozMatchesSelector || e.oMatchesSelector ||
    ...
    o = function () {
      ...
      return n(e, [{
        key: "create",
        value: function (e) {
          return "disabled" !== this.opt.wildcards &&
        ...
        value: function (e) {
          var t = this.opt.synonyms,
            ...
            r = this.opt.ignoreJoiners || this.opt.ignorePunctuation.length
              ? "\0"
              : "";
          for (var i in t) {
            if (t.hasOwnProperty(i)) {
              var o = t[i],
                a = "disabled" !== this.opt.wildcards
                  ? this.setupWildcardsRegExp(i)
                  : this.escapeStr(i),
                s = "disabled" !== this.opt.wildcards
              ...
              "" !== a && "" !== s &&
                (e = e.replace(
                  ...
                  r + "(" + this.processSynonyms(a) + "|" +
                    this.processSynonyms(s) + ")" + r,
                ));
            }
          }
          return e;
      ...
      return n(a, [{
        ...
        value: function (t) {
          var n = arguments.length > 1 && void 0 !== arguments[1]
              ...
              : "debug",
            r = this.opt.log;
          this.opt.debug && "object" === (void 0 === r ? "undefined" : e(r)) &&
            "function" == typeof r[n] && r[n]("mark.js: " + t);
        },
      }, {
        ...
        value: function (e, t) {
          ...
          return e && void 0 !== e.start
            ? (r = (n = parseInt(e.start, 10)) + parseInt(e.length, 10),
              this.isNumeric(e.start) && this.isNumeric(e.length) &&
                r - t > 0 && r - n > 0
                ? i = !0
                : (this.log(
        ...
        value: function (e, t, n) {
          ...
          return (r = (s = s > o ? o : s) + parseInt(e.length, 10)) > o &&
            (r = o,
        ...
        key: "wrapGroups",
        value: function (e, t, n, r) {
          return r((e = this.wrapRangeInTextNode(e, t, t + n)).previousSibling),
            e;
        },
      }, {
        key: "separateGroups",
        ...
        value: function (e, t) {
          ...
          var r = 0,
            ...
            c = a.length;
          this.opt.acrossElements && (i = "wrapMatchesAcrossElements"),
            0 === c ? this.opt.done(r) : function e(t) {
              var a = new o(n.opt).create(t), u = 0;
              n.log('Searching with expression "' + a + '"'),
                n[i](a, 1, function (e, i) {
                  return n.opt.filter(i, t, r, u);
                }, function (e) {
                  u++, r++, n.opt.each(e);
                }, function () {
                  0 === u && n.opt.noMatch(t),
                    s[c - 1] === t ? n.opt.done(r) : e(s[s.indexOf(t) + 1]);
                });
            }(s[0]);
        },
      }, {
