...
Deno.test({
  ...
  async fn() {
    const input = "a,b,c\n1,2,3\n4,5,6";
    const result = await csvToTsv(input, { fieldsPerRecord: 3 });
...
Deno.test({
  ...
  async fn() {
    ...
    const result = await csvToTsv(input, { fieldsPerRecord: 2 });
...
Deno.test({
  ...
  async fn() {
    ...
    assertThrows(
      () => await csvToTsv(input, { fieldsPerRecord: 3 }),
      Error,
      "Parse error"
    );
  },
...
Deno.test({
  ...
  async fn() {
    ...
    assertThrows(
      () => await csvToTsv(input, { fieldsPerRecord: 2 }),
      Error,
      "Parse error"
    );
  },
...
Deno.test({
  ...
  async fn() {
    const input = "header\nvalue1\nvalue2";
    const result = await csvToTsv(input, { fieldsPerRecord: 1 });
...
Deno.test({
  ...
  async fn() {
    ...
    try {
      const result = await csvToTsv(input); // No fieldsPerRecord specified
      assertEquals(typeof result, "string");
    } catch (error) {
