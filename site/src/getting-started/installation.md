...
The data transforms module is **separate from the core library** to keep the
main import lightweight. Import it when you need CSV, TSV, JSON, or Record
format conversions:
...
- **Smaller bundles**: Users who only need process management don't import
  transform code
...
proc needs permissions to run child processes and access files. When you run
your script, Deno will prompt you, or you can grant them upfront:
...
Ready to write your first proc script? Head to the
